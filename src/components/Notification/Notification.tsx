...
function Notification() {
   ...
   */
  const MarkAsRead = (_event: any, index: any, ReadAll: boolean = false) => {
    ...
    if (ReadAll === false) {
      ...
      apiData = apiData.map((message: MessageData, _key: number) => {
  ...
  return (
    <>
      ...
      <Modal
        ...
        className="cls-modal"
        width={364}
        closeIcon={<Text className="cls-close-icon Infi-Sp_03_CloseIcon"></Text>}
        // ref={bottom_ref}
        footer={
          <>
            {/* <Divider plain />
