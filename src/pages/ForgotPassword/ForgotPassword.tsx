...
const ForgotPassword = (props:any) => {
  ...
  // const [, LsetIsResetLink] = localStorageAccessor("isResetLink");
      ...
      {/* {showLoginpage ? (
        ...
        >
          ...
          <FormTitle
            ...
            subTitle={
              (fpHide === "" ? "forgot_subtitle" : "") || 
              (fpHide === "otp" ? "We have sent an OTP to " + userName + ", please enter the same to proceed" : "") || 
              (fpHide === "pswChange" ? "This password should be different from the previous password" : "") || 
              (fpHide === "completed" ? "Your password has been successfully updated" : "")
            }
          />
            ...
            >
              ...
              <Form.Item>
                <Button
                  ...
                  type="link"
                  className="link cls-fp-btn h-47 w-100"
                >
                  {t("back_to_login")}
                </Button>
              </Form.Item>
              ...
              <Form.Item>
                {fpHide === "otp" ? (
                  <Button
                    ...
                    type="primary"
                    disabled={!Disablebtn}
                    className="cls-fp-btn cls-primaryBtn h-47 w-100"
                    onClick={() => {
